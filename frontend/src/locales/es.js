...
export default {
  ...
  'Source code & legal notices': 'Código fuente y avisos legales',
  'Open-source license and third-party acknowledgements': 'Licencia de código abierto y reconocimientos de terceros',
  'Corresponding source code': 'Código fuente correspondiente',
  'based on': 'basado en',
  'Exercise metadata and instructions: hasaneyldrm/exercises-dataset (MIT).': 'Metadatos e instrucciones de ejercicios: hasaneyldrm/exercises-dataset (MIT).',
  'Exercise images and animations are third-party content.': 'Las imágenes y animaciones de ejercicios son contenido de terceros.',
